...
<article>
		...
		<div class="spe">
			<div class="spe2">
			   ...
			   <p> zuletzt aktualisiert: 18:11, 28.02.</p> 
				...
				<p> Woche(  -  ): </p><br>
				 ...
				 <h1>Das nächste Turnier beginnt am 03.04.</h1> 
				 <p><a href="#Mach-mit">Mach mit!</a></p>
			</div>
		</div>
			...
			<div class="spe">
				<div class="spe2">
                          <h1>Info</h1>
                           Links wird die Anzahl der Teilnehmer  gezeigt. Einmal die  <br>
                           Anzahl von der aktuellen, laufenden Runde und einmal <br>
                           von der eins vorherigen Runde. Außerdem wird das Datum <br>
                           gezeigt, damit man einen groben Überblick hat, wann das <br>
                           letzte Turnier war und wie lang das jetzige Turnier noch <br>
                           läuft. Die Anzahl der Teilnehmer wird alle 4 Stunden <br>
						   erhöht, das heißt das es mehr Teilnehmer sein könnten, <br>
						   als da angezeigt wird. Auch könnt ihr sehen, wann das <br>
						   nächste Turnier ist. Ihr könnt euch jederzeit für das <br>
						   Turnier registrieren, da es keine deadline für die <br>
						   Registration gibt. <br><br><br>
 						   <a href="#Mach-mit">Mach mit!</a> <br>
...
<article>
		<div class="spe">	
			<div class="spe2">
		 <form  action="https://aber.duverliersteh.de" method="post">
         	...
         	<p><u>E-mail:</u><span id="sternchen">*</span></p> <br>
         	<input type="email" name="email" placeholder="example@gmail.com" required="" autocomplete="on" method="post"> <br>
         	<p id="ema"><span id="sternchen">*</span><u>E-mail wird benötigt, um euch zu benachrichtigen, wenn ihr gewinnt!</u></p>
			<input type="submit" name="" value="Ich mache mit!">
         </form>
         
         <?php
          	$con =  mysqli_connect('localhost','turnier','Ibrahimeren7171','turnier');
           
            if ($con->connect_error): 
              echo "no connection dude";
            endif;
              
            if (isset($_POST['submit'])) {
              $name = $_POST['name'];
              $email = $_POST['email'];
              $absenden = $con->prepare("INSERT INTO turnier (name, email) VALUES (?,?)");
              $absenden->bind_param('ss', $name, $email);
              $absenden->execute();
            }   
           ?>
          	</div>  	        
      ...
      <div class="spe">
 		 <div class="spe2">
							<h1> Anmeldung zum Turnier</h1>
				Hier könnt ihr euch für das Turnier anmelden. Es ist, wie bereits in <a href="#Über-das-Spiel">diesem</a> Abschnitt <br>
				erwähnt, kostenlos und ohne irgendeine Anmeldung! Ihr könnt irgendein Namen eingeben,<br>
				falls ihr nicht euer Instagram oder Snapchat Namen angeben wollt und eure Mail, damit<br>
				ihr benachrichtigt werden könnt, falls ihr gewonnen habt oder nicht. Wenn ihr<br>
				eure echte Mail nicht angeben wollt, dann müsst ihr dies auch nicht tun! Ihr<br>
				könnt irgendeine fake E-mail angeben, dann bekommt ihr halt keine Benachrichtigung.<br>
				Dies sollte aber nicht so schlimm sein, denn falls ihr euren Snapchat- oder<br> 
				Instagramnamen angegeben habt, dann kann ich euch über diese App bescheid geben.<br>
			    Fall ihr auch nicht euren Snap- oder Instanamen angeben wollt, dann ist dies auch<br> 
			    kein Problem! Dann wird es halt schwer, euch eine Benachrichtigung zu schicken,<br>
			    dass ihr gewonnen habt. Die einzige Möglichkeit ist, dass ihr die Seite nach einer<br>
			    Woche wieder besucht, um zu sehen, wer der <a href="#Letzter-Gewinner">letzte Gewinner</a> war.<br>
			    Jeder Teilnehmer zählt! Warum? Weil, wenn die Anzahl der Teilnehmer steigt, dann<br> 
			    werden auch die Preise steigen! Anfangs wird leider nur ein Preis vergeben, und<br> 
			    zwar der Name des Gewinners. Nach einer bestimmten Zeit werden es auch Preise wie<br>
			    eine PSN-Karte sein. Ich hoffe euch gefällt mein Konzept und die Art der Umsetzung.<br>
			    Falls euch mangelhafte Stellen oder bessere Umsetzungsideen einfallen, dann klickt<br>
			    <a href="#end">hier</a>, um meine E-Mail zu sehen und über die Mail eure Idee mitteilen zu können!
...
<div class="spe">
	<div class="spe2">
				<h1>Unbezahlte "Werbung"</h1>
				Gibt zu, dass Samsung besser ist als Iphone, und Huawei besser als Samsung. Samsung ist meiner Meinung nach tot, da die neuen Modelle schon bereits nach einem halben Jahr stark an Wert verlieren, d.h. sie werden nur noch fast zur Hälfte des ursprünglichen Preises verkauft.Iphone ist an sich nicht schlecht (mit Iphone mein ich Apple natürlich), aber dieses Unternehmen zieht die Leute ab in meinen Augen. Sonst sind die Produkte gar nicht schlecht gemacht. Huawei ist wie ein Newcomer in der Rapszene. Huawei bringt derzeit die modernsten und intelligentesten Handys raus und hat somit die Top 1 verdient. Wir fangen mit dem Punkt an, dass die Huawei mate pro Serie eine artificial intelligence, also künstliche Intelligenz, die KI, besitzt. Darüber hinaus verfügt das Handy über viele Funktionen, die Samsung und Iphone vielleicht auch haben, aber paar auch nicht, wie zum Beispiel den <a href="https://www.youtube.com/watch?v=KVjg9WQMvoE" target="_blank">Desktop-Modus</a>.
	</div>
</div>
<article>
<div class="spe">
	<div class="spe2">
		 <h1>Beste Serien</h1>
		 <a href="https://youtu.be/jrLhP5sK2wI">-The Punisher</a> <br>
		 <a href="https://youtu.be/4SzFubsoW1M">-Rick and Morty</a> <br>
		 <a href="https://youtu.be/g4wzLlflvhg">-Family Guy</a> <br>
		 <a href="https://youtu.be/yK8e0EQE3O0">-The Protector</a> <br>
		 <a href="https://youtu.be/Qofw470E0-k">-Haus des Geldes</a> (Bald kommt dritte Staffel) <br>
		 <a href="https://youtu.be/vJAoxBQ6hs0">-Pickpockets:Meister im Stehlen</a> (Film) <br>
		 Erste Priorität auf Rick & Morty, bisschen pervers an manchen Stellen, <br> aber trotzdem sehr lustig und gut gemacht.
	</div>
</div>
...
<div class="spe">
	<div class="spe2">
			<h1>Gute Musik</h1>
			<a href="https://youtu.be/eFN0Zzflors">-JAJA</a> Fero47 <br>
			<a href="https://youtu.be/7dh93lkFKv4">-Dogs of Berlin</a> Sinan-G <br>
			<a href="https://youtu.be/zGEsbNGXYts">-Ausländer</a> Mert <br>
			<a href="https://youtu.be/ee3BxXFfPNg">-Santa Maria</a> LOKO BEN <br>
			<a href="https://youtu.be/rCY5sCVTSPA">-u21</a> Mert <br>
			<a href="https://youtu.be/_7OLff7HYo0">-Drama</a> Bizzey, Boef <br>
...
<div class="spe6">
	<div class="spe2">
 			<h4><u>Gelange wieder nach ganz oben</u></h4>
 			Ich will wieder <br> nach <a href="#headerr">oben</a>!
	</div>
</div>
</article>
...
<table  class="tableess" border="1" cellspacing="0">
	...
	<tr>
		<td><u>FEEDBACK</u>: Falls ihr mangelhafte Stellen entdeckt, dann meldet es sofort bei mir! Danke :) Ich werde versuchen, diese Fehler zu beheben! Meine Mail findet ihr ganz unten unter "Kontakt:"!</td>
	</tr>

	<tr>
		<td><u>UPDATES:</u> Chat in der Website (kommt bald) <br> Falls ihr noch was wollt, dann mailt mir.</td>
	</tr>
